...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAI4TCP9unyH4fc"; // AccessKeyId

        $accessKeySecret = "5esG3zRFHtg3VoyvL8nAKvX5olRcx5"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($mobile, $smsSign, $smsParam , $templateCode) {
