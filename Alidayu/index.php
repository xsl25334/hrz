...
$c = new TopClient;
$c->appkey = "LTAI4TCP9unyH4fc";  //App Key的值 这个在开发者控制台的应用管理点击你添加过的应用就有了
$c->secretKey = "5esG3zRFHtg3VoyvL8nAKvX5olRcx5"; //App Secret的值也是在哪里一起的 你点击查看就有了
...
$req->setSmsParam("{'code':'1234'}"); //这个是短信签名
$req->setRecNum("15138669939"); //这个是写手机号码
$req->setSmsTemplateCode("SMS_150744103"); //这个是模版ID 主要也是短信内容
$resp = $c->execute($req);
var_dump($resp);